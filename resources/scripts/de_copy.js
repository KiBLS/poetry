// copy link to the specific poem to clipboard (newversion-de)
...
function copyDivToClipboard(element) {
  ...
  if (element.classList.contains("copypoem")) {
    var license = "<br>" + "Lizenz: CC BY-SA 4.0";
    poemText += license;
  }
  ...
  if (element.classList.contains("copypoem")) {
    element.innerHTML = "Gedicht erfolgreich kopiert！<br><br><span class='wrapper'><span class='triangleleft'></span><span class='circle'></span><span class='triangleright'></span></span>";
  } else {
    element.innerHTML = "Link erfolgreich kopiert!";
  }
