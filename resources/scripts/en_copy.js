...
function copyDivToClipboard(element) {
  ...
  if (element.classList.contains("copypoem")) {
    element.innerHTML = "Poem successfully copied!<br><br><span class='wrapper'><span class='triangleleft'></span><span class='circle'></span><span class='triangleright'></span></span>";
  } else {
    element.innerHTML = "Link has been successfully copied!";
  }
