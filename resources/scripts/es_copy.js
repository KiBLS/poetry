// copy link to the specific poem to clipboard (newversion-en)
...
function copyDivToClipboard(element) {
  ...
  if (element.classList.contains("copypoem")) {
    var license = "<br>" + "Licence: CC BY-SA 4.0";
    poemText += license;
  }
  ...
  if (element.classList.contains("copypoem")) {
    element.innerHTML = "¡Poema copiado con éxito!<br><br><span class='wrapper'><span class='triangleleft'></span><span class='circle'></span><span class='triangleright'></span></span>";
  } else {
    element.innerHTML = "¡El enlace se ha copiado correctamente!";
  }
