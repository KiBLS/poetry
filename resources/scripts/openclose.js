...
if (currentTheme === "dark") styleLink.href = `${path}/kiblsstyle.css`;
else if (currentTheme === "light") styleLink.href = `${path}/kiblsstylelight.css`;

btn.addEventListener("click", () => {
  if (styleLink.getAttribute("href") !== `${path}/kiblsstyle.css`) {
    styleLink.href = `${path}/kiblsstyle.css`;
    localStorage.setItem("theme", "dark");
  } else {
    styleLink.href = `${path}/kiblsstylelight.css`;
