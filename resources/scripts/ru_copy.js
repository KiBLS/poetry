...
function copyDivToClipboard(element) {
  ...
  if (element.classList.contains("copypoem")) {
    var license = "<br>" + "Лицензия: CC BY-SA 4.0";
    poemText += license;
  }
  ...
  if (element.classList.contains("copypoem")) {
    element.innerHTML = "Стихотворение успешно скопировано!<br><br><span class='wrapper'><span class='triangleleft'></span><span class='circle'></span><span class='triangleright'></span></span>";
  } else {
    element.innerHTML = "Ссылка успешно скопирована!";
  }
